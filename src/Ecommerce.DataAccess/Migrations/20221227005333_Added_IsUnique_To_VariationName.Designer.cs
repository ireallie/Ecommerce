...
namespace Ecommerce.DataAccess.Migrations
{
    ...
    [Migration("20221227005333_Added_IsUnique_To_VariationName")]
    partial class Added_IsUnique_To_VariationName
    {
            ...
            modelBuilder.Entity("Ecommerce.DataAccess.Entities.Products.Product", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ProductId = 1,
                            CreatedDate = new DateTimeOffset(new DateTime(2022, 12, 27, 0, 53, 32, 390, DateTimeKind.Unspecified).AddTicks(4711), new TimeSpan(0, 0, 0, 0, 0)),
