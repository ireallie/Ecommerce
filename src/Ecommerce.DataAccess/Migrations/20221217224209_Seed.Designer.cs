            ...
            modelBuilder.Entity("Ecommerce.DataAccess.Entities.Products.Product", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ProductId = 1,
                            CreatedDate = new DateTimeOffset(new DateTime(2022, 12, 17, 22, 42, 8, 614, DateTimeKind.Unspecified).AddTicks(3048), new TimeSpan(0, 0, 0, 0, 0)),
